 ...
 */
final class Version20241025113924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE receta (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, texto VARCHAR(1024) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
